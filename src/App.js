...
class App extends Component {
  ...
  render() {
    ...
    console.log(this.state.cateselect);
          ...
          action: {
            ...
            EditItem: (id) => {
              ...
              axios({ url: host + "api/v1/items/edit/" + id, method: "POST", data: formData, headers: headers })
                ...
                .catch(function (error) { if (error.request.response) {  toast(error.request.response, {
                  position: "bottom-center",
                  autoClose: 5000,
                  hideProgressBar: false,
                  closeOnClick: true,
            ...
            EditCate: (id) => {
              ...
              axios({ url: host + "api/v1/sections/edit/" + id, method: "POST", data: formData, headers: headers })
                ...
                .catch(function (error) { if (error.request.response) { 
